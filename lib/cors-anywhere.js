...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    originWhitelist: ['fightstream.is'],            // If non-empty, requests not from an origin in this list will be blocked.
  ...
  return function(req, res) {
    ...
    if (location.host === 'crossdomain.xml') {
      ...
      res.end('<?xml version="1.0" encoding="UTF-8"?><cross-domain-policy xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.adobe.com/xml/schemas/PolicyFile.xsd"><allow-access-from domain="fightstream.is" /><site-control permitted-cross-domain-policies="master-only"/><allow-http-request-headers-from domain="*.fightstream.is" headers="*" secure="true"/></cross-domain-policy>');
      return;
    }
